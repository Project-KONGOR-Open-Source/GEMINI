// (C)2008 S2 Games
// mesh_color_unit_diffuse_scroll.vsh
// 
// Default unit vertex shader with a scrolling texture layer on top
//=============================================================================
...
VS_OUTPUT VS( VS_INPUT In )
{
	...
	Out.Texcoord1.xy      = In.Texcoord0 + vUVScroll1 * fTime + vUVScroll2 * fTime;
	Out.Texcoord1.wz      = In.Texcoord0 + vUVScroll1 * fTime - vUVScroll2 * fTime;
#if (LIGHTING_QUALITY == 0 || FALLOFF_QUALITY == 0)
